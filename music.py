...
image_icon = PhotoImage(
    file="D:/Code/Python/MP3 Music Player/images/logo.png")
root.iconphoto(False, image_icon)

Top = PhotoImage(
    file="D:/Code/Python/MP3 Music Player/images/top.png")
